...
export const metadata: Metadata = {
  title: "Sicily Travels - Explore the Beauty of Sicily",
  description: "Join Sicily Travels to discover the enchanting landscapes and culture of Sicily.",
  metadataBase: new URL("https://sicilytravels.com"),
  alternates: {
    canonical: "https://sicilytravels.com"
  },
  openGraph: {
    title: "Sicily Travels - Explore the Beauty of Sicily",
    description: "Join Sicily Travels to discover the enchanting landscapes and culture of Sicily.",
    url: "https://sicilytravels.com",
    siteName: "Sicily Travels",
    images: [
      { url: "https://images.pexels.com/photos/31574487/pexels-photo-31574487.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "Sicily landscape" }
    ],
    type: "website"
  },
  twitter: {
